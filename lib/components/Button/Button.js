...
var Button = function (_a) {
    ...
    return (_jsx(ButtonWrapper, { children: _jsx("button", __assign({ type: "button", className: ["storybook-button", "storybook-button--" + size, mode].join(" "), style: { backgroundColor: backgroundColor } }, props, { children: label }), void 0) }, void 0));
};
